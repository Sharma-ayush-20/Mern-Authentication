...
function Header() {
    ...
    return (
        <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
            ...
            <button className='border border-gray-500 rounded-full px-8 py-2 hover:bg-blue-600 hover:text-white font-medium transition-all cursor-pointer'>Get Started</button>
        </div>
    )
}
